...
class HomeViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cashaddr = AppController.shared.wallet!.publicKey.toCashaddr()
    ...
    private func getBalance() {
        APIClient().getUnspentOutputs(withAddresses: [AppController.shared.wallet!.publicKey.toAddress()], completionHandler: { [weak self] (utxos:[UnspentOutput]) in
    ...
    private func getTxHistory() {
        APIClient().getTransaction(withAddresses: AppController.shared.wallet!.publicKey.toAddress(), completionHandler: { [weak self] (transactrions:[CodableTx]) in
